...
/**
 * @file mqtt_device_trigger.h
 *
 * @brief mqtt_device_trigger Class.
 *
...
class MqttDeviceTrigger : public HaVirtualSwitch {
public:
  MqttDeviceTrigger(unsigned index) : HaVirtualSwitch(index) {}
  ~MqttDeviceTrigger() override {}
